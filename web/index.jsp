...
<head>
    ...
    <script type="text/javascript">
        ...
        function zTreeOnClick(event, treeId, treeNode) {
            ...
            if (treeNode.isParent) {
                $('#here_area').html(treeNode.resourceName);
            } else {
                $('#here_area').html(treeNode.resourceName);
            }
            var dangqianweizhi = treeNode.resourceName;
        };
        ...
        function loadMenu(resourceType, treeObj) {
            ...
            data = [
                ...
                {
                    "accessPath": "listPersonal.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listTraining.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 38,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalTele.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalIsDangyuan.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalIsTuanyuan.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalZhizhao.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalCar.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
                ...
                {
                    "accessPath": "listPersonalChild.action",
                    "checked": false,
                    "delFlag": 0,
                    "parentID": 3,
                    "resourceCode": "",
        ...
        <div id="top_op">
            <ul>
                <li>
                    ...
                    <span><s:property value="personalSession.ACCOUNT.ACCOUNTKESHI" />:<s:property value="personalSession.XINMIN" /></span>
                </li>
                <li>
...
<!-- side menu start -->
<div id="top_nav">
    <span>当前位置：&nbsp;>&nbsp;</span><span id="here_area">系统介绍</span>
</div>
<div id="main">
    <iframe name="right" id="rightMain" src="introduce.html" frameborder="no" scrolling="auto" width="100%"
